...
<body class="page-header-fixed">
            ...
            <div class="col-md-12">
               ...
               <div class="portlet box red">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-external-link"></i>Links</div>
                  </div>
                  <div class="portlet-body">
                     <div class="table-toolbar">

						<div class="btn-group">
                           <a class="btn blue" data-toggle="modal" href="#link">
                           Agregar Link <i class="icon-plus"></i>
                           </a>
                        </div>
                     </div>
                     <table class="table table-striped table-bordered table-hover" id="tabla_link">
                        <thead>
                           <tr>
                              <th>Nombre</th>
                              <th>Editar</th>
                        ...
                        <tbody>
							<?php 
							$sql = "SELECT id, nombre, link FROM link ORDER BY nombre ASC";
							...
							if ($consulta){
								...
								?>
									<tr class="odd gradeX">
									  ...
									  <td><a href="editarlink.php?id=<?php echo $link['id'];?>">Editar</a></td>
									  <td><a id="borrarlink" link-id="<?php echo $link['id'];?>" href="#">Borrar</a></td>
								    </tr>
								<?php 
								}
							}else{
				  ...
				  <!-- MODAL categoria -->
				  <div class="modal fade" id="link" tabindex="-1" role="link" aria-hidden="true">
					<div class="modal-dialog">
					   <div class="modal-content">
						  <div class="modal-header">
							 <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							 <h4 class="modal-title">Agregar link</h4>
						  </div>
						  <!-- BEGIN FORM-->
						  <form action="#" id="agregar_link" class="form-horizontal">
						  <div class="modal-body">
								<div class="form-body">
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-md-8">
										 <input type="text" name="nombrelink" data-required="1" class="form-control"/>
									  </div>
								   </div>
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-md-8">
										 <input type="text" name="urllink" data-required="1" class="form-control"/>
									  </div>
								   </div>
				  ...
				  <script type="text/javascript">
					function enviarFormLink(){
					  ...
					  datosForm.append('nombrelink',$("#agregar_link input[name=nombrelink]").val());
					  datosForm.append('nombreurl',$("#agregar_link input[name=urllink]").val());

					  $.ajax({
						url:'agregarlink.php', //Url a donde la enviaremos
						...
						if(msg==0){
							...
							$('.alert-success', $('#agregar_link')).show();//Muestra mensaje de link agregado
							alert('Link agregado.');
							$('#link').modal('hide')
							location.reload();
						}else{
   ...
   <script src="assets/scripts/tabla-link.js"></script>
