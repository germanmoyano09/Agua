var TablaLink = function () {
    ...
    return {
        ...
        init: function () {
            ...
            // begin first table
            var oTable = $('#tabla_link').dataTable({
                ...
                "oLanguage": {
                    "sLengthMenu": "_MENU_ links por página",
                    "oPaginate": {
                        "sPrevious": "Anterior",
                        "sNext": "Siguiente"
                    }
            ...
            jQuery('#tabla_link .group-checkable').change(function () {
			...
			$('#borrarlink').live('click', function (e) {
				e.preventDefault();

				if (confirm("Seguro que desea eliminar el link?") == false) {
					return;
				}
				
				var idlink = $(this).attr("link-id");
				$.ajax({
					type:"POST",
					url: "borrarlink.php",
					data:{id:idlink}
            ...
            jQuery('#tabla_link tbody tr .checkboxes').change(function(){
                 $(this).parents('tr').toggleClass("active");
            });
