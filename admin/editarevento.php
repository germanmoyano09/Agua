            ...
            <div class="col-md-12">
               ...
               <div class="portlet box red">
                  ...
                  <div class="portlet-body">
					  ...
					  <!-- BEGIN FORM-->
						  <form action="actualizarevento.php" id="agregar_evento" class="form-horizontal">
								...
								<div class="form-body">
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-md-8">
										 <?php 
											$id = $_GET['id'];
											$sql = "SELECT nombre, link FROM evento WHERE id= '$id'";
											$consulta = mysqli_query($conexion, $sql);
											$error = "";
											if ($consulta){
												while ($evento=mysqli_fetch_array($consulta)){
										 ?>
													<input type="text" name="nombreevento" data-required="1" class="form-control" value="<?php echo $evento['nombre']; ?>"/>
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-md-8">
											<input type="text" name="urlevento" data-required="1" class="form-control" value="<?php echo $evento['link']; ?>"/>
						  ...
						  <div class="modal-footer">
							 <a href="evento.php" type="button" class="btn default" >Volver</a>
				  ...
				  <script type="text/javascript">
					function enviarFormEvento(){
					 ...
					 // var archivos = document.getElementById("fotoportada");//Damos el valor del input tipo file
					  ...
					  datosForm.append('nombre',$("#agregar_evento input[name=nombreevento]").val());
					  datosForm.append('url',$("#agregar_evento input[name=urlevento]").val());
					  datosForm.append('id', '<?php echo $_GET['id'] ?>');
					  
					  $.ajax({
						url:'actualizarevento.php', //Url a donde la enviaremos
						...
						if(msg==0){
							...
							$('.alert-success', $('#agregar_evento')).show();//Muestra mensaje de lugar agregado
